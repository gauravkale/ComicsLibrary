package com.sample.comicslibrary.model.api

import com.sample.comicslibrary.BuildConfig
import com.sample.comicslibrary.getHash
...
object ApiService {
    ...
    private fun getRetrofit(): Retrofit {
        ...
        val hash = getHash(ts, privateKey = apiSecret, publicKey = apiKey)
